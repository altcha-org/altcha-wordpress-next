...
use AltchaOrg\Altcha\V1\Obfuscator as ObfuscatorV1;
...
function altcha_obfuscate_shortcode_handler($atts, $content = null): string
{
  ...
  if (empty($obfuscated) && !empty($content)) {
    $obfuscator = new Obfuscator(new Altcha(), new Pbkdf2());
    $obfuscated = $obfuscator->obfuscate($content, cost: 5000, counterMin: 1, counterMax: 200);
  }
  ...
  return "<altcha-widget " .
    "data-obfuscated=\"" . esc_attr($obfuscated) . "\" " .
    "display=\"floating\" >" .
